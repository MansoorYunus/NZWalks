    ...
    public partial class SeedingDataforRegionsandDifficulties : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("9d903891-996b-437b-8cd4-eeab0b43500a"), "Medium" },
                    { new Guid("c76b76f5-8991-43ee-a87d-ab1e96b44a9e"), "Hard" },
                    { new Guid("e5daaf05-01df-4476-857e-541ee9bda0be"), "Easyy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("9d903891-996b-437b-8cd4-eeab0b43500a"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("c76b76f5-8991-43ee-a87d-ab1e96b44a9e"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("e5daaf05-01df-4476-857e-541ee9bda0be"));
